...
describe 'navigate' do
  ...
  describe 'new' do
    it 'has a link from the homepage' do
      employee = Employee.create(first_name: 'Employee', last_name: 'Ronaldo', email: 'employee@example.com', password: 'ff12fe', password_confirmation: 'ff12fe', phone: '+2345678912345')
